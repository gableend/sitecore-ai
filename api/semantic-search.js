...
const contentEmbeddings = {
  ...
  "personalization-ai-scale": {
    ...
    content: "Personalization at AI Scale represents the evolution from basic segmentation to true 1:1 personalization through AI. Advanced machine learning algorithms analyze user behavior, preferences, and context in real-time to deliver unique experiences for every visitor. Implementation involves sophisticated data collection across touchpoints, AI-powered processing engines that understand user intent, dynamic content orchestration systems, and continuous learning mechanisms that improve over time. Key benefits include real-time adaptation to user behavior, enterprise-scale deployment capabilities, predictive intelligence that anticipates user needs, and cross-channel consistency. Modern personalization platforms leverage vector embeddings, knowledge graphs, and multimodal AI to create experiences that feel intuitive and relevant. The technology enables dynamic content assembly, contextual recommendations, behavioral prediction, and automated optimization across all digital touchpoints.",
    embedding: null,
    type: "hot_topic",
