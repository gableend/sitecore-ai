...
export default function CountdownTimer({ className = '', textColor = 'text-gray-600' }: CountdownTimerProps) {
  ...
  return (
    <div className={`flex flex-wrap justify-center gap-6 ${className}`}>
      <div className="flex flex-col items-center">
        ...
        <div className={`mt-2 text-sm uppercase tracking-wide font-medium ${textColor}`}>Days</div>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className={`mt-2 text-sm uppercase tracking-wide font-medium ${textColor}`}>Hours</div>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className={`mt-2 text-sm uppercase tracking-wide font-medium ${textColor}`}>Minutes</div>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className={`mt-2 text-sm uppercase tracking-wide font-medium ${textColor}`}>Seconds</div>
      </div>
    </div>
  );
}
