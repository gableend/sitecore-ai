...
function CaseStudyCard({ caseStudy }: { caseStudy: Message['caseStudy'] }) {
  ...
  return (
    <div className="mt-4 mb-2 p-6 border border-orange-200 rounded-xl bg-orange-50 shadow-sm animate-fade-in w-full">
      <div className="flex items-start gap-8">
        ...
        <div className="flex-1 max-w-[60%]">
          ...
          <div className="space-y-3">
            ...
            <div className="mt-4 pt-3 border-t border-orange-200">
              <Link
                to={caseStudy.url}
                className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white text-sm font-medium rounded-lg transition-all duration-200 hover:shadow-md transform hover:scale-105"
              >
        ...
        <div className="flex-shrink-0 w-80 h-56 bg-white rounded-lg p-2 shadow-sm border border-orange-100">
          <img
  ...
  const hotTopics = [
    {
      ...
      prompt: 'Tell me about conversational user experiences and their impact',
      response: 'Conversational UX transforms traditional interfaces into natural, dialogue-driven experiences. By integrating AI-powered conversations directly into digital touchpoints, brands can create intuitive interactions that feel human while providing instant, contextual assistance. This approach reduces friction, increases engagement, and guides users through complex journeys with personalized, conversational guidance.',
      link: '/agentic-experience?topic=conversational-ux',
      description: 'Transform interfaces into natural, dialogue-driven experiences'
    },
    {
      id: 'future-of-search',
      title: 'Future of Search',
      prompt: 'How is AI revolutionizing search and discovery experiences?',
      response: 'The future of search goes beyond keywords to understanding intent, context, and meaning. AI-powered search delivers personalized results, anticipates user needs, and provides conversational answers. With semantic understanding, visual search, and predictive capabilities, modern search experiences become proactive digital assistants that find what users need before they even ask.',
      link: '/agentic-experience?topic=future-of-search',
      description: 'Discover intelligent search that understands intent and context'
    },
    {
      id: 'ai-scale-personalization',
      title: 'AI Scale Personalization',
      prompt: 'How can AI deliver personalization at massive scale?',
      response: 'AI Scale Personalization enables brands to deliver unique, tailored experiences to millions of users simultaneously. By processing real-time behavioral data, historical preferences, and contextual signals, AI creates individualized content, recommendations, and journeys for each user. This approach transforms one-size-fits-all experiences into millions of personalized touchpoints.',
      link: '/agentic-experience?topic=ai-scale-personalization',
      description: 'Deliver unique experiences to millions of users simultaneously'
    },
    {
      id: 'dynamic-content',
      title: 'Dynamic Content',
      prompt: 'How does AI transform content creation and adaptation?',
      response: 'Dynamic Content uses AI to automatically adapt, generate, and optimize content across channels and audiences. From real-time language translation and format adaptation to audience-specific messaging and A/B testing, AI ensures every piece of content is perfectly tailored for its context, audience, and delivery channel.',
      link: '/agentic-experience?topic=dynamic-content',
      description: 'Automatically adapt and optimize content across all channels'
    },
    {
      id: 'experience-agents',
      title: 'Experience Agents',
      prompt: 'What are Experience Agents and how do they transform digital interactions?',
      response: 'Experience Agents are intelligent AI systems that act as proactive digital assistants, orchestrating personalized customer journeys across all touchpoints. These agents understand user context, predict needs, and autonomously execute complex tasks while maintaining brand consistency. They transform passive websites into active, intelligent partners that guide, assist, and delight users throughout their entire experience.',
      link: '/agentic-experience?topic=experience-agents',
      description: 'Intelligent agents that orchestrate personalized customer journeys'
    }
  ];
  ...
  const handleHotTopicClick = (topic: typeof hotTopics[0]) => {
    ...
    switch (topic.id) {
      case 'conversational-ux':
        topicImage = '/images/conversational-ux.png';
        break;
      case 'future-of-search':
        topicImage = '/images/future-of-search.png';
        break;
      case 'ai-scale-personalization':
        topicImage = '/images/ai-scale-personalization.png';
        break;
      case 'dynamic-content':
        topicImage = '/images/dynamic-content.png';
        break;
      case 'experience-agents':
        topicImage = '/images/experience-agents.png';
        break;
      default:
    ...
    const assistantMessage: Message = {
      ...
      caseStudy: {
        ...
        challenge: "Implementing cutting-edge AI solutions",
        solution: "Sitecore AI-powered experiences",
        results: ["Enhanced user engagement", "Improved conversion rates", "Streamlined operations"],
          ...
          <div className="mb-6">
            <div className="flex items-center mb-4">
              <div className="flex items-center">
                <svg className="w-5 h-5 text-orange-500 mr-2 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              {hotTopics.map((topic, index) => (
                <button
                  ...
                  className="group relative overflow-hidden bg-gradient-to-r from-orange-400 to-red-500 hover:from-orange-500 hover:to-red-600 text-white px-4 py-3 rounded-full text-sm font-medium transition-all duration-300 hover:shadow-lg hover:scale-105 transform"
                  style={{
