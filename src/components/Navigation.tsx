        ...
        <div className="flex items-center py-4">
          ...
          <div className="flex-grow flex justify-center">
            <nav className="hidden md:flex space-x-10">
              ...
              <Link to="/agentic-events" className="text-base font-medium text-gray-900 hover:text-gray-700 border-b-2 border-transparent hover:border-red-500 transition-all duration-150 px-2 py-1">
                Agentic Events
              </Link>
            </nav>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="pt-2 pb-4 px-4 space-y-1">
            ...
            <Link to="/agentic-events" className="block py-2 px-3 text-base font-medium text-gray-900 hover:bg-gray-50 rounded-md">
              Agentic Events
            </Link>
            <a
              href="https://www.sitecore.com"
